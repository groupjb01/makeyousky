...
from data_loader import lowest_ability_codes
from data_loader import lowest_ability_codes, SCHOOL_TYPE_ADJUSTMENT
...
def show_info_input():
    ...
    lowest_ability = st.selectbox("📉 수능최저 역량을 선택하세요", list(lowest_ability_codes.keys()))
